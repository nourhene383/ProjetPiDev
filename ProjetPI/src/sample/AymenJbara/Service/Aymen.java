package sample.AymenJbara.Service;
...
import sample.AymenJbara.Entity.Books;
import sample.AymenJbara.Entity.FactureE;
import sample.AymenJbara.Entity.FactureEmp;
import sample.AymenJbara.Entity.Stat;
...
public class Aymen implements Initializable {
    ...
    public ObservableList<FactureE> getFactureEList(){
        ...
        try {
            ...
            FactureE facture1;
            while (rs.next()){
                facture1 =new FactureE(rs.getString("id_Fac"), rs.getString("nom_client"),rs.getDate("date_fac"), rs.getString("reglement_fac"), rs.getString("etat_fac"), rs.getInt("TVA_fac"), rs.getInt("remise_fac"), rs.getString("NB_fac"), rs.getInt("Totale_fac") );
...
//**********************************************
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ObservableList<String> listL = FXCollections.observableArrayList("Le paiement a été effectué","factures archivée");
        ...
        ObservableList<String> listEmp2 = FXCollections.observableArrayList("Le salaire a été envoyé","pas en coré");
    ...
    private void insertRecord1(){
        String query ="INSERT INTO factures_clients VALUES('"+random_id()+"','"+ nameClient.getText() +"','"+ date_fac.getValue()+"','"+ModeReglement+"','"+Etat+"',"+TVA_fac.getText()+","+remise_fac.getText()+",'"+NB_fac.getText()+"',"+Totale.getText()+")";
        executeQuery(query);
        showBooks();
        search_facture();
    }
