package sample.AymenJbara.Entity;
...
public class FactureE {
    ...
    public FactureE(String id, String nomClient, Date date, String Regliment, String EtatFacture, int TVA, int Remise, String NBFacture, int Totale) {
        this.id = id;
