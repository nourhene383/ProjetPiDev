...
package GestionEvent.GUIMap;

import static GestionEvent.GUIMap.MapController.map_value;
                ...
                try {
                    ...
                    if (response == JOptionPane.NO_OPTION) {
                        ...
                        if (userSelection == JFileChooser.APPROVE_OPTION) {
                            ...
                            db_path = "localhost/coachini/uploads/" + fileNameInServer.substring(fileNameInServer.indexOf("f"));
                            stage.close();
                            stage.fireEvent(
                                    new WindowEvent(
                                            stage,
